    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BorrowingSlips", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BorrowingSlips_Books_BorrowedBookId",
                        column: x => x.BorrowedBookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BorrowingSlips_Users_BorrowerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BorrowingSlips_BorrowedBookId",
                table: "BorrowingSlips",
                column: "BorrowedBookId");

            migrationBuilder.CreateIndex(
                name: "IX_BorrowingSlips_BorrowerId",
                table: "BorrowingSlips",
                column: "BorrowerId");
